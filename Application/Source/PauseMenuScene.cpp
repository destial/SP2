...
void PauseMenuScene::RenderMesh(Mesh* mesh, bool enableLight)
{
...
void PauseMenuScene::RenderText(Mesh* mesh, std::string text, Color color)
{
...
void PauseMenuScene::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
{
	if (!mesh || mesh->textureID <= 0) //Proper error check
		return;
...
void PauseMenuScene::RenderMeshOnScreen(Mesh* mesh, float size, float x, float y) {
...
void PauseMenuScene::InitGLXray()
{
...
void PauseMenuScene::RenderSkybox() {
	float translate = 50;
